...
const HeroSection = () => {
  return (
    <div className='w-full min-h-[550px] mb-4' style={{background: "linear-gradient(160.29deg, #00b53f, .67%, #00831e 100.93% )"}}>
                    ...
                    <CardContent className='py-10 px-5'>
                        <div className='w-full flex flex-col items-center'>
                            <h2 className='text-[30px] md:text-[46px] font-extrabold leading-10 md:leading-[50px]'>
                                <span className="">Find the car <br/>of your dreams</span>{" "}
